...
class JobController:
    ...
    def create(cls, slack_channel_id, job_url, origin, company=None):
        if (
            Job.query.filter_by(
                slack_channel_id=slack_channel_id, job_url=job_url
            ).first()
            is None
        ):
            new_job = Job(
    ...
    @classmethod
    def get(cls, slack_channel_id, job_url):
    ...
    @classmethod
    def delete(cls, slack_channel_id, job_url):
        job = Job.query.filter_by(
            slack_channel_id=slack_channel_id, job_url=job_url
        ).first()
        if job is None:
