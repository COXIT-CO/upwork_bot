...
class TestClient(unittest.TestCase):
    ...
    def test_create_client_404(self):
        ...
        user.save()
        data = ["Kate", "~012e124456e16572e7"]
        assert ClientController.create(data) == "User with this name or url is already exist!"

    def test_read_client_data_200(self):
        expected = {"Kate": "https://www.upwork.com/jobs/~012e124456e16572e7",
    ...
    def test_read_user_urls_200(self):
        ...
        data_to_job()
        data = "Vova"
        expected = {'https://www.upwork.com/jobs/~01d924c5f6e5aa0918',
